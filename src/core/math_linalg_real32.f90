submodule (math) math_linalg_real32
    !! Math submodule with 32-bit real linear algebra routines.
    !!
    !! Sub-module to the `math` module containing the definition of the
    !! procedures for 32-bit real linear algebra algorithms.

contains

! ======================================================================

module procedure s_cross

    vecC(1) = vecA(2)*vecB(3) - vecA(3)*vecB(2)
    vecC(2) = vecA(3)*vecB(1) - vecA(1)*vecB(3)
    vecC(3) = vecA(1)*vecB(2) - vecA(2)*vecB(1)

end procedure s_cross

! ======================================================================

module procedure s_cross_mat_mat
    integer :: i, j, m, n
...
end procedure s_cross_mat_mat

! ======================================================================

module procedure s_cross_mat_vec
...
end procedure s_cross_mat_vec

! ======================================================================

module procedure s_cross_vec_mat
...
end procedure s_cross_vec_mat

! ======================================================================

module procedure s_det
...
end procedure s_inv_mat

! ======================================================================

end submodule math_linalg_real32
