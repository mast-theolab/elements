module vibrational
    ...
    interface build_modes
        ...
        module procedure &
            build_modes_arr_lt, build_modes_arr_sq, &
            build_modes_dim_lt, build_modes_dim_sq, &
...
subroutine build_modes_arr_lt(F_cart, at_crd, at_mass, is_weighted, &
...
subroutine build_modes_arr_sq(F_cart, at_crd, at_mass, is_weighted, &
                              remove_rottrans, n_vib, L_mat, freq, L_mweigh, &
                              red_mass)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
...
subroutine build_modes_dim_lt(n_at, F_cart, at_crd, at_mass, is_weighted, &
                              remove_rottrans, n_vib, L_mat, freq, L_mweigh, &
                              red_mass)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
...
subroutine build_modes_dim_sq(n_at, F_cart, at_crd, at_mass, is_weighted, &
                              remove_rottrans, n_vib, L_mat, freq, L_mweigh, &
                              red_mass)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
...
subroutine build_modes_mol_lt(F_cart, mol, is_weighted, remove_rottrans, &
                              n_vib, L_mat, freq, L_mweigh, red_mass)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
    !! Interface routine to call main algorithm with Cartesian force
...
subroutine build_modes_mol_sq(F_cart, mol, is_weighted, remove_rottrans, &
                              n_vib, L_mat, freq, L_mweigh, red_mass)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
    !! Interface routine to call main algorithm with Cartesian force
...
subroutine build_modes_vib_lt(F_cart, mol, vib, is_weighted, remove_rottrans, &
                              set_nvib, set_Lmat, set_freq, set_Lmweigh, &
                              set_redmas)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
    !! Interface routine to call main algorithm with Cartesian force
...
subroutine build_modes_vib_sq(F_cart, mol, vib, is_weighted, remove_rottrans, &
                              set_nvib, set_Lmat, set_freq, set_Lmweigh, &
                              set_redmas)
    !! Build the normal modes from the Cartesian force constant matrix.
    !!
